...
users = {
    1: {"name": "Marsiya", "locale": "fr", "timezone": "Europe/Paris"},
    2: {"name": "Issah", "locale": "en", "timezone": "US/Central"},
    3: {"name": "Jane", "locale": "kg", "timezone": "Vulcan"},
    4: {"name": "Doe", "locale": None, "timezone": "Europe/London"},
}
...
def get_user(id) -> Union[Dict[str, Union[str, None]], None]:
    ...
    Returns:
        (Dict): return user dictionary if id is valid else None
    """
